...
public class PokerDynamics {
    ...
    public void startHand( BufferedReader cardFile) {
    	...
    	hole[0][0]= Card.get( cards.substring(0,2)); 
        hole[0][1]=Card.get( cards.substring(2,4));
        hole[1][0]=Card.get( cards.substring(4,6));
        hole[1][1]=Card.get( cards.substring(6,8));
        
        board[0]=Card.get( cards.substring(8,10));
        board[1]=Card.get( cards.substring(10,12));
        board[2]=Card.get( cards.substring(12,14));
        board[3]=Card.get( cards.substring(14,16));
        board[4]=Card.get( cards.substring(16,18));
