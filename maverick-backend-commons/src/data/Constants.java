...
public class Constants {
	...
	public static final boolean DEBUG_IMMI = false && DEBUG;
	public static final long HANDCOUNT = 6000;

	public static long HANDTIME = 12000 / (AVAILABLE_CPUS < 2 ? 2 : AVAILABLE_CPUS);
	...
	public static final int SIGNIFICANT_ROUND_COUNT = 6;
	...
	public final static int NUM_ROUNDS_BEFORE_HISTORY = 10;
	public static final double A_PREFLOP = -2.0;
	
//	public static LevenshteinMap<Double> AGGRESSIVE_PREFLOP;
	
	public static long NODE_ID = 0;
//	public static final double A_RAISE = 15.0;
//	public static LevenshteinMap<Double> AGGRESSIVE_RAISE;
